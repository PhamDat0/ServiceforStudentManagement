...
<html>
    ...
    <body>
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="src/image/test.png" width="80%" alt="First Slide">

                            </div>
                            <div class="item">
                                <img src="src/image/abc_1.jpg" width="80%" alt="Second Slide">
                            </div>
                        </div>
        ...
        <div class="container fixdisplay">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4"><h4>ABOUT US</h4>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4"><h4>OUR BENEFIT</h4>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4"><h4>TESTIMONIAL</h4>
