...
public class AccountDAO {
    ...
    public void insertAccount(Account acc) throws Exception {
        ...
        ps.setString(6, acc.getRoleNumber());
        ps.setString(7, acc.getAddress());
        ps.setString(8, acc.getPhone());
        ps.setDate(9, (java.sql.Date) acc.getDob());
        ps.setInt(10, acc.getWalletID());
        ps.setInt(11, acc.getBalance());
        ps.setDate(12, (java.sql.Date) acc.getDateCreated());
        ps.setString(13, acc.getStatus());
        ps.setInt(14, acc.getType());
        ps.executeUpdate();
        conn.close();
    }
